    ...
    <div className="min-h-screen bg-white text-ink">
      <section className="pt-36 pb-20 lg:pt-52 lg:pb-32 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <span className="inline-flex items-center gap-2 px-3 py-1  bg-off border border-[rgba(0,0,0,0.08)] text-[10px] font-normal text-mid uppercase tracking-[0.18em] mb-6">EB-5 Investment</span>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-light leading-[1.06] mb-5">
            EB-5 Real Estate<br /><span className="text-mid">Projects in the USA</span>
          </h1>
          <p className="text-xl text-mid font-light leading-relaxed max-w-3xl"><Link to="/" className="underline hover:text-ink transition-colors">Z-Co Development</Link> offers qualified EB-5 investment opportunities in high-quality U.S. real estate projects that create substantial American jobs and provide a structured path toward U.S. permanent residency for qualifying foreign nationals.</p>
        </motion.div>
      </section>

      <section className="py-20 border-t border-[rgba(0,0,0,0.07)] px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-serif font-light text-ink mb-5">What Is EB-5 & Why Real Estate?</h2>
      ...
      <section className="py-20 border-t border-[rgba(0,0,0,0.07)] bg-off px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-serif font-light text-ink mb-4">Z-Co EB-5 Investment Advantages</h2>
          <p className="text-mid mb-12 text-lg">Z-Co provides a structured, transparent EB-5 investment experience backed by experienced developers and a proven project pipeline.</p>
      ...
      <section className="py-20 border-t border-[rgba(0,0,0,0.07)] px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto space-y-6 text-mid leading-relaxed">
          <h2 className="text-3xl sm:text-4xl font-serif font-light text-ink">How to Get Started with Z-Co EB-5</h2>
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            ...
            <Link to="/about" className="inline-flex items-center gap-2 px-5 py-2.5 border border-[rgba(0,0,0,0.1)] text-ink  font-normal uppercase text-[11px] tracking-[0.14em] hover:border-white transition-all">About Z-Co <ArrowRight className="w-3.5 h-3.5" /></Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 border-t border-[rgba(0,0,0,0.07)] px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          <h2 className="text-3xl sm:text-4xl font-serif font-light text-ink">Explore EB-5 Investment with Z-Co</h2>
          <p className="text-mid text-lg leading-relaxed">Join a growing community of international investors building their U.S. future through Z-Co's real estate development platform. Request your investor packet today.</p>
