        ...
        <div className="pt-32 pb-20 lg:pt-48 lg:pb-36 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
            ...
            >
                ...
                <div className="prose prose-invert prose-lg max-w-none text-ink">
                    ...
                    <h2 className="text-2xl font-bold text-ink mt-12 mb-6">1. Acceptance of Terms</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-bold text-ink mt-12 mb-6">2. Use of Services</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-bold text-ink mt-12 mb-6">3. Intellectual Property Rights</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-bold text-ink mt-12 mb-6">4. Limitation of Liability</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-bold text-ink mt-12 mb-6">5. Forward-Looking Statements</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-bold text-ink mt-12 mb-6">6. Modifications to Terms</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-bold text-ink mt-12 mb-6">7. Governing Law</h2>
                    <p>
