  ...
  return (
    <>
      ...
      <header className="relative isolate min-h-screen flex flex-col justify-end pb-0 lg:pb-4 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 w-full pt-[368px]">
          <motion.div
          ...
          <div className="max-w-5xl mx-auto text-center mb-16 px-4">
            ...
            <div className="flex flex-wrap justify-center gap-x-12 gap-y-4">
              {[
                ...
                >
                  <div className="h-[7px] w-[7px] rounded-full bg-slate-500/50" />
                  <span className="text-[11.5px] sm:text-[12.7px] font-bold text-white uppercase tracking-wider">{item}</span>
                </motion.div>
              ))}
            </div>
          </div>
