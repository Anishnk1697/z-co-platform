        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="space-y-5 text-slate-400 leading-relaxed">
              ...
              <p>Our investment approach is grounded in three core principles: recession resistance, replication, and transparency. We select projects in essential-service sectors — <Link to="/build-to-rent-developer-usa" className="underline hover:text-white transition-colors">build-to-rent housing</Link>, <Link to="/healthcare-real-estate-developer" className="underline hover:text-white transition-colors">healthcare</Link>, and community anchored <Link to="/mixed-use-real-estate-developer" className="underline hover:text-white transition-colors">mixed-use</Link> — that remain in demand across economic cycles. We develop using repeatable, standardized archetypes that reduce risk and improve margins with every project. And we communicate openly with our investors at every stage of the development process.</p>
