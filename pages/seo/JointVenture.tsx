    ...
    <div className="min-h-screen bg-black text-white">
      <section className="pt-36 pb-20 lg:pt-52 lg:pb-32 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <p className="text-xl text-slate-400 font-light leading-relaxed max-w-3xl">Z-Co Development is an experienced real estate joint venture partner bringing a fully integrated development platform, institutional-quality execution, and proven replication systems to co-development opportunities across the U.S. Sun Belt.</p>
        </motion.div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-5 text-slate-400 leading-relaxed">
              ...
              <p>Z-Co is currently seeking joint venture partners for build-to-rent residential communities, healthcare real estate developments, and mixed-use projects across Texas, Florida, and Arizona. If you have a site, a capital commitment, or a development opportunity, we would welcome a conversation about how Z-Co can serve as your development partner.</p>
            </div>
          </div>
        </div>
      </section>
