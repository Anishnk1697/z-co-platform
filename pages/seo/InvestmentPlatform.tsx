    ...
    <div className="min-h-screen bg-white text-ink">
      <section className="pt-36 pb-20 lg:pt-52 lg:pb-32 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <span className="inline-flex items-center gap-2 px-3 py-1  bg-off border border-[rgba(0,0,0,0.08)] text-[10px] font-normal text-mid uppercase tracking-[0.18em] mb-6">Investment Platform</span>
      ...
      <section className="py-20 border-t border-[rgba(0,0,0,0.07)] px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto space-y-5 text-mid leading-relaxed">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            ...
            <Link to="/portfolio" className="inline-flex items-center gap-2 px-5 py-2.5 border border-[rgba(0,0,0,0.1)] text-ink  font-normal uppercase text-[11px] tracking-[0.14em] hover:border-white transition-all">View Projects <ArrowRight className="w-3.5 h-3.5" /></Link>
          </div>
        </div>
      </section>
