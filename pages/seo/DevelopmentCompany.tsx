        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-5 text-slate-400 leading-relaxed">
              ...
              <p>Z-Co is actively seeking investors, landowners, joint venture partners, and EB-5 capital partners to expand our platform across these high-conviction markets. We are committed to transparent communication, aligned incentive structures, and the highest standards of professional conduct in every relationship we build.</p>
            </div>
          </div>
        </div>
      </section>
