  ...
  return (
    <div className="min-h-screen bg-white text-ink">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-5 text-mid leading-relaxed">
              ...
              <p>Z-Co is currently seeking joint venture partners for <Link to="/build-to-rent-developer-usa" className="underline hover:text-ink transition-colors">build-to-rent residential</Link> communities, <Link to="/healthcare-real-estate-developer" className="underline hover:text-ink transition-colors">healthcare real estate</Link> developments, and <Link to="/mixed-use-real-estate-developer" className="underline hover:text-ink transition-colors">mixed-use projects</Link> across Texas, Florida, and Arizona. If you have a site, a capital commitment, or a development opportunity, we would welcome a conversation about how Z-Co can serve as your development partner.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 border-t border-[rgba(0,0,0,0.07)] bg-off px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-serif font-light text-ink mb-4">Z-Co Joint Venture Partner Types</h2>
          <p className="text-mid mb-12 text-lg">Z-Co actively pursues partnerships with a range of partners who bring complementary strengths to the development process.</p>
      ...
      <section className="py-20 border-t border-[rgba(0,0,0,0.07)] px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto space-y-5 text-mid leading-relaxed">
          <h2 className="text-3xl sm:text-4xl font-serif font-light text-ink mb-5">Z-Co's Development Platform — What You Get When You Partner With Us</h2>
      ...
      <section className="py-24 border-t border-[rgba(0,0,0,0.07)] px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          <h2 className="text-3xl sm:text-4xl font-serif font-light text-ink">Let's Build Together</h2>
