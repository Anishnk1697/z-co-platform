    ...
    <div className="min-h-screen bg-black text-white">
      <section className="pt-36 pb-20 lg:pt-52 lg:pb-32 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <p className="text-xl text-slate-400 font-light leading-relaxed max-w-3xl">Z-Co Development leverages prefabricated construction methods to deliver high-quality real estate projects up to 50% faster than traditional methods — compressing timelines, reducing costs, and improving outcomes for investors and communities.</p>
        </motion.div>
      </section>
      ...
      <section className="py-20 border-t border-slate-900 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-5 text-slate-400 leading-relaxed">
              <p>The financial case for prefabricated construction in real estate development is compelling. A project delivered 30–50% faster spends less time accruing construction loan interest, reaches revenue faster, and provides investors with quicker return of capital. Simultaneously, factory manufacturing reduces per-unit material and labor costs compared to site-built alternatives — improving project-level economics for both developers and their investors.</p>
              <p>Z-Co's projects span multiple asset types — build-to-rent residential communities, healthcare facilities, and mixed-use developments — all of which benefit from prefabricated construction approaches. Our team selects the appropriate blend of prefabricated and traditional techniques for each project, optimizing cost, schedule, and quality based on site conditions, local regulatory requirements, and market delivery expectations.</p>
