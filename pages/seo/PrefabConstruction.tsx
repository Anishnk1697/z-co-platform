  ...
  return (
    <div className="min-h-screen bg-white text-ink">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-5 text-mid leading-relaxed">
              ...
              <p>Z-Co's <Link to="/portfolio" className="underline hover:text-ink transition-colors">projects</Link> span multiple asset types — <Link to="/build-to-rent-developer-usa" className="underline hover:text-ink transition-colors">build-to-rent residential communities</Link>, <Link to="/healthcare-real-estate-developer" className="underline hover:text-ink transition-colors">healthcare facilities</Link>, and <Link to="/mixed-use-real-estate-developer" className="underline hover:text-ink transition-colors">mixed-use developments</Link> — all of which benefit from prefabricated construction approaches. Our team selects the appropriate blend of prefabricated and traditional techniques for each project, optimizing cost, schedule, and quality based on site conditions, local regulatory requirements, and market delivery expectations.</p>
      ...
      <section className="py-20 border-t border-[rgba(0,0,0,0.07)] bg-off px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-serif font-light text-ink mb-4">Prefabricated Construction Advantages</h2>
          <p className="text-mid mb-12 text-lg">How prefabricated methods improve every dimension of real estate development performance.</p>
      ...
      <section className="py-20 border-t border-[rgba(0,0,0,0.07)] px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto space-y-5 text-mid leading-relaxed">
          <h2 className="text-3xl sm:text-4xl font-serif font-light text-ink mb-5">Z-Co's Prefabricated Construction Philosophy</h2>
      ...
      <section className="py-24 border-t border-[rgba(0,0,0,0.07)] px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          <h2 className="text-3xl sm:text-4xl font-serif font-light text-ink">Invest in Smarter Construction</h2>
