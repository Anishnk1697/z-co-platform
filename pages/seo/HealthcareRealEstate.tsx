    ...
    <div className="min-h-screen bg-white text-ink">
      ...
      <section className="py-20 border-t border-[rgba(0,0,0,0.07)] px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-serif font-light text-ink mb-5">The Case for Healthcare Real Estate Investment</h2>
      ...
      <section className="py-20 border-t border-[rgba(0,0,0,0.07)] bg-off px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-serif font-light text-ink mb-4">Why Healthcare Real Estate Outperforms</h2>
          <p className="text-mid mb-12 text-lg">Demographic, structural, and economic forces make healthcare real estate one of the strongest long-term investment sectors.</p>
      ...
      <section className="py-20 border-t border-[rgba(0,0,0,0.07)] px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-serif font-light text-ink mb-5">Featured Project: MedPlex — Katy, Texas</h2>
          <div className="space-y-5 text-mid leading-relaxed">
      ...
      <section className="py-24 border-t border-[rgba(0,0,0,0.07)] px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          <h2 className="text-3xl sm:text-4xl font-serif font-light text-ink">Partner with a Healthcare Real Estate Developer</h2>
