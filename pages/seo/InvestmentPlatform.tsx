    ...
    <div className="min-h-screen bg-black text-white">
      <section className="pt-36 pb-20 lg:pt-52 lg:pb-32 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-900 border border-slate-800 text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-6">Investment Platform</span>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-[1.1] mb-8">
            Real Estate Investment<br /><span className="text-slate-400">Platform</span>
          </h1>
          <p className="text-xl text-slate-400 font-light leading-relaxed max-w-3xl">Z-Co Development is an integrated real estate investment platform built for investors who want disciplined underwriting, transparent reporting, and institutional-quality returns from carefully selected development opportunities in the U.S. Sun Belt.</p>
        </motion.div>
      </section>

      <section className="py-20 border-t border-slate-900 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">An Investment Platform Built on Execution</h2>
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="space-y-5 text-slate-400 leading-relaxed">
              ...
              <p>Our investment approach is grounded in three core principles: recession resistance, replication, and transparency. We select projects in essential-service sectors — build-to-rent housing, healthcare, and community anchored mixed-use — that remain in demand across economic cycles. We develop using repeatable, standardized archetypes that reduce risk and improve margins with every project. And we communicate openly with our investors at every stage of the development process.</p>
            ...
            <div className="space-y-5 text-slate-400 leading-relaxed">
              ...
              <p>Z-Co's current pipeline exceeds $250M across build-to-rent, healthcare, and mixed-use development projects. We are actively seeking qualified investors, family offices, and institutional co-investment partners to expand this pipeline in the highest-conviction markets in the United States.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 border-t border-slate-900 bg-slate-950/30 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Investment Platform Highlights</h2>
          <p className="text-slate-400 mb-12 text-lg">What makes Z-Co's platform a compelling choice for sophisticated real estate investors.</p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-7 rounded-2xl bg-slate-900/60 border border-slate-800">
                ...
                <div className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-3">{item.label}</div>
      ...
      <section className="py-20 border-t border-slate-900 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto space-y-5 text-slate-400 leading-relaxed">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">How to Invest with Z-Co</h2>
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            ...
            <Link to="/portfolio" className="inline-flex items-center gap-2 px-5 py-2.5 border border-slate-700 text-white rounded-full font-bold uppercase text-xs tracking-widest hover:border-white transition-all">View Projects <ArrowRight className="w-3.5 h-3.5" /></Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 border-t border-slate-900 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          <h2 className="text-3xl sm:text-4xl font-bold text-white">Access the Z-Co Investment Platform</h2>
          <p className="text-slate-400 text-lg leading-relaxed">Join a growing base of investors building wealth through Z-Co's disciplined, execution-first real estate investment platform. Request your investor packet and start the conversation today.</p>
